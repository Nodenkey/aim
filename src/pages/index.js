          ...
          <div className="row what-we-do">
            <div className="col-md-6 order-2 order-md-1">
              ...
              <p>
                ...
                discovered and developed to benefit industry. That is why we are
                continually looking and developing talents across Africa to feed
                industry.
              </p>
            </div>
          ...
          <div className="row">
            <div className="col-md-4 activity">
              <div className="card">
                ...
                <Img fluid={images.socialImpact.childImageSharp.fluid} className="card-img-top" alt="..." />
              </div>
            </div>
            <div className="col-md-4 activity">
              <div className="card">
                ...
                <Img fluid={images.training.childImageSharp.fluid} className="card-img-top" alt="..." />
              </div>
            </div>
            <div className="col-md-4 activity">
              <div className="card">
        ...
        <div className="container">
          <div className="row text-center">
            <div className="col-md-12">
              ...
              <p>
                At Trestle Academy Ghana(TAG), we have been involved with our
                ever growing community, and are happy to share our achievements
                with you. For many years, we have been making a difference in
                the lives of youth in Africa. Get involve today!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row text-center">
            <div className="col-md-12">
              ...
              <p>
                Every Friday | Department of Computer Science, University of
                Ghana
              </p>
